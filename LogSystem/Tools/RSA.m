...
+ (NSString *)encryptDic:(NSDictionary *)dic publicKey:(NSString *)pubKey{
    NSData *dicData =  [RSA encryptData: [NSJSONSerialization dataWithJSONObject:dic options:NSJSONWritingPrettyPrinted error:nil] publicKey:pubKey];
    NSString *ret = base64_encode_data(dicData);
    return ret;
}
